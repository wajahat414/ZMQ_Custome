...
void checkReturnCode(int code, {List<int> ignore = const []}) {
  if (code < 0) {
    checkErrorCode(ignore: ignore);
  }
}

void checkErrorCode({List<int> ignore = const []}) {
  final errorCode = bindings.zmq_errno();
